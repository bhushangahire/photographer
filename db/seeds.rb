...
photographer = Photographer.create(
  :email => "clicks@bhushangahire.net",
  :password => "password",
  :site_url => 'http://clicks.bhushangahire.net',
  :company_name => 'Clicks', 
  :company_email => 'bhushangahire2007@gmail',
  :blog_url => 'http://clicks.bhushangahire.net',
  :use_watermark => false,
  :theme => 'default',
  :google_analytics_key => 'UA-8004674-3',
  :google_verification_key => '',
  :home_page_title => 'Clicks by Bhushan Ahire'
)
...
client = photographer.clients.create(:name => 'Demo Client', :email => "client@bhushangahire.net", :password => "password")
